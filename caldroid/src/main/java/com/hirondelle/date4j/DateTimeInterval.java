package com.hirondelle.date4j;

import com.hirondelle.date4j.DateTime.DayOverflow;
import com.hirondelle.date4j.DateTime.Unit;
...
final class DateTimeInterval {
    ...
    private void checkUnits() {
        ...
        if (fFrom.unitsAllPresent(Unit.YEAR, Unit.MONTH, Unit.DAY, Unit.HOUR, Unit.MINUTE, Unit.SECOND)) {
            ...
            success = fFrom.unitsAllAbsent(Unit.YEAR, Unit.MONTH, Unit.DAY) && fFrom.unitsAllPresent(Unit.HOUR, Unit.MINUTE, Unit.SECOND);
        if (!success) {
